...
import cast1e from '~/assets/developerAvatar/cast1e.jpg'
...
<template>
  <div class="license-container">
    <h1>雪灾浙大 Enhanced</h1>
    <h3>By ZJUKongroo 工作室</h3>
    <h2>Developers 开发者</h2>
    <div class="colbox">
      <div class="developer-card colbox">
        <img :src="cast1e" class="developer-card-avatar" />
        <div class="developer-card-info">
          <div class="colbox">
            <div class="developer-card-name">cast1e</div>
            <div class="developer-card-job">Leader</div>
          </div>
          <div class="developer-card-email">rooger@zju.edu.cn</div>
        </div>
      </div>
    </div>
    ...
    <h2>Licenses 使用的开源项目及协议</h2>
    <div class="project-card-container">
      <div
        v-for="project in usedProjects"
        :key="project.name"
        class="project-card"
...
.developer-card .developer-card-job {
  font-size: 13px;
}
...
.project-card:hover {
  background-color: var(--xzzd-bg-color-alter);
}
